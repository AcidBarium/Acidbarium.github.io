const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-ES59byhe.js","./splitpanes.es-oE07QrQG.js","./index-DKnSvpEK.css","./migration-BPggtrZx.js"])))=>i.map(i=>d[i]);
...
const routes = [
  {
    path: "/",
    name: "/",
    component: () => __vitePreload(() => import('./index-ES59byhe.js'),true?__vite__mapDeps([0,1,2]):void 0,import.meta.url)
    /* no children */
  },
  {
    path: "/about",
    name: "/about",
    component: () => __vitePreload(() => import('./about-DIN6FYRD.js'),true?[]:void 0,import.meta.url)
    /* no children */
  },
  {
    path: "/categories",
    name: "/categories",
    component: () => __vitePreload(() => import('./categories-qSfQ0X1a.js'),true?[]:void 0,import.meta.url)
    /* no children */
  },
  {
    path: "/migration",
    name: "/migration",
    component: () => __vitePreload(() => import('./migration-BPggtrZx.js'),true?__vite__mapDeps([3,1]):void 0,import.meta.url)
    /* no children */
  },
  {
    path: "/tags",
    name: "/tags",
    component: () => __vitePreload(() => import('./tags-BQz02NM_.js'),true?[]:void 0,import.meta.url)
    /* no children */
  }
];
...
export { toHandlers as $, contains as A, BaseStyle as B, getScrollableParents as C, isClient$1 as D, EventBus as E, Fragment as F, setAttribute as G, localeComparator as H, getFocusableElements as I, find as J, findSingle as K, getIndex as L, getAttribute as M, relativePosition as N, getOuterWidth as O, absolutePosition as P, isTouchDevice as Q, addStyle as R, normalizeStyle as S, Teleport as T, resolveDynamicComponent as U, Transition as V, vShow as W, withKeys as X, clearSelection as Y, getSelection as Z, _export_sfc as _, createBaseVNode as a, useI18n as a0, dayjs as a1, clientPageData as a2, activePath as a3, toRaw as a4, pageData as a5, onMounted as a6, rpc as a7, getDefaultExportFromCjs as a8, useScroll as a9, postList as aa, isStaticMode as ab, vModelCheckbox as ac, vModelText as ad, getKeyValue as ae, isFunction$2 as af, toCapitalCase as ag, service_default as ah, config_default as ai, isString$2 as aj, toFlatCase as ak, resolve$1 as al, isObject$3 as am, isEmpty as an, PrimeVueService as ao, isArray$3 as ap, removeClass as aq, getHeight as ar, getWidth as as, getOuterHeight as at, getOffset as au, addClass as av, createElement as aw, h as ax, renderSlot as b, createElementBlock as c, createCommentVNode as d, equals as e, resolveFieldData as f, getAppWindow as g, resolveComponent as h, isNotEmpty as i, renderList as j, createBlock as k, createSlots as l, mergeProps as m, normalizeClass as n, openBlock as o, withCtx as p, defineComponent as q, resolveDirective as r, ref as s, toDisplayString$1 as t, useModel as u, watch as v, withDirectives as w, createVNode as x, unref as y, createTextVNode as z };
