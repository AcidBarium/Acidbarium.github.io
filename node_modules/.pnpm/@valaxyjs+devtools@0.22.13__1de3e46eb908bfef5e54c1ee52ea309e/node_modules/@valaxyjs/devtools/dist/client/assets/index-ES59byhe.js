  ...
  methods: {
    ...
    onOptionSelect: function onOptionSelect(event, option, index) {
      ...
      if (this.multiple) {
        ...
        });else newValue = this.d_value ? [].concat(_toConsumableArray$3(this.d_value), [optionValue]) : [optionValue];
      } else {
        ...
        "default": withCtx(function () {
          return [_ctx.inline || $data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
            ...
            return openBlock(), createElementBlock("div", mergeProps({
              ...
              "data-pc-group-section": "view"
            }), toDisplayString($options.getMonthName(month.month)), 17, _hoisted_5$2)) : createCommentVNode("", true)], 64)) : (openBlock(), createElementBlock(Fragment, {
              key: 1
              ...
              "data-pc-group-section": "view"
            }), toDisplayString($options.getMonthName(month.month)), 17, _hoisted_6$1)) : createCommentVNode("", true), $data.currentView !== 'year' ? (openBlock(), createElementBlock("button", mergeProps({
              key: 1,
              type: "button",
