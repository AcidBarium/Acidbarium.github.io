...
function drawCanvas() {
    ...
    drawText("00:" + String(TimeConsue) + ":" + getRandomInt(1, 60).toString().padStart(2, "0"), 30, 1013, 30, "black", true, 1, true)
    drawText(textPeishu, 240, 1013, 30, "black", true, 1, true);   //输出配速
    drawText(String(TimeConsue * 10 + getRandomInt(1, 30) - 10), 440, 1013, 30, "black", true, 1, true);
